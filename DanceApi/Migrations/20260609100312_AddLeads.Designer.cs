...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DanceApi.Model.FAQ", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DanceApi.Model.GuestInstructorProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ShowOnPublicInstructorsPage")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("GuestInstructorProfiles");
                });

            modelBuilder.Entity("DanceApi.Model.GuestUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DanceApi.Model.GuestUserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GuestUserProfiles");
                });

            modelBuilder.Entity("DanceApi.Model.InstructorProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DanceApi.Model.Lead", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ConvertedGuestUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConvertedGuestUserId");
            ...
            modelBuilder.Entity("DanceApi.Model.Meeting", b =>
                {
                    ...
                    b.Property<int?>("GuestInstructorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DanceApi.Model.MeetingGuestParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MeetingGuestParticipants");
                });
            ...
            modelBuilder.Entity("DanceApi.Model.MembershipPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DanceApi.Model.UserMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DanceApi.Model.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MembershipPlanTypeOfMeeting", b =>
                {
                    b.Property<int>("AccessibleMeetingTypesId")
                        .HasColumnType("int");

                    b.Property<int>("MembershipPlansId")
                        .HasColumnType("int");

                    b.HasKey("AccessibleMeetingTypesId", "MembershipPlansId");

                    b.HasIndex("MembershipPlansId");

                    b.ToTable("MembershipPlanTypeOfMeeting");
                });
            ...
            modelBuilder.Entity("DanceApi.Model.GuestInstructorProfile", b =>
                {
                    b.HasOne("DanceApi.Model.GuestUser", "GuestUser")
                        .WithOne("GuestInstructorProfile")
                        .HasForeignKey("DanceApi.Model.GuestInstructorProfile", "GuestUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DanceApi.Model.GuestUserProfile", b =>
                {
                    b.HasOne("DanceApi.Model.GuestUser", "GuestUser")
                        .WithOne("GuestUserProfile")
                        .HasForeignKey("DanceApi.Model.GuestUserProfile", "GuestUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DanceApi.Model.InstructorProfile", b =>
                {
                    b.HasOne("DanceApi.Model.User", "User")
                        ...
                        .HasForeignKey("DanceApi.Model.InstructorProfile", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DanceApi.Model.Lead", b =>
                {
                    b.HasOne("DanceApi.Model.GuestUser", "ConvertedGuestUser")
                        .WithMany()
                        .HasForeignKey("ConvertedGuestUserId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("ConvertedGuestUser");
            ...
            modelBuilder.Entity("DanceApi.Model.Meeting", b =>
                {
                    ...
                    b.HasOne("DanceApi.Model.GuestUser", "GuestInstructor")
                        .WithMany()
                        .HasForeignKey("GuestInstructorId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("DanceApi.Model.MeetingGuestParticipant", b =>
                {
                    b.HasOne("DanceApi.Model.GuestUser", "GuestUser")
                        .WithMany("MeetingGuestParticipants")
            ...
            modelBuilder.Entity("DanceApi.Model.UserMembership", b =>
                {
                    ...
                    b.HasOne("DanceApi.Model.MembershipPlan", "MembershipPlan")
                        .WithMany()
            ...
            modelBuilder.Entity("DanceApi.Model.UserProfile", b =>
                {
                    b.HasOne("DanceApi.Model.User", "User")
                        .WithOne("UserProfile")
                        .HasForeignKey("DanceApi.Model.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MembershipPlanTypeOfMeeting", b =>
                {
                    b.HasOne("DanceApi.Model.TypeOfMeeting", null)
                        .WithMany()
                        .HasForeignKey("AccessibleMeetingTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DanceApi.Model.MembershipPlan", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DanceApi.Model.GuestUser", b =>
                {
                    b.Navigation("GuestInstructorProfile");

                    b.Navigation("GuestUserProfile");

                    b.Navigation("MeetingGuestParticipants");
                });
